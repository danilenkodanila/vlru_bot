...
if setNews == 0: 
     ...
     def repeat(message): 
        bot.send_message(message.chat.id, test.funcText(1), disable_web_page_preview = True) #посылаем в ответ ссылку 2 из массива ссылок в файле парс. 
     ...
     def repeat(message): 
        bot.send_message(message.chat.id, test.funcText(20), disable_web_page_preview = True) #посылаем в ответ 
